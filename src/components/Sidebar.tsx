...
export function Sidebar({onSelectKeyword, handleFirstKeyword, sidebarOpen, handleSidebarToggle}) {
    ...
    return (
      <>
            <div className={`sidebar-wrapper fixed top-0 z-10 flex w-full flex-col border-b lg:bottom-0 lg:z-auto lg:w-56 2xl:w-64 lg:border-b-0 lg:border-r ${sidebarOpen ? "block" : "hidden"}`}>
